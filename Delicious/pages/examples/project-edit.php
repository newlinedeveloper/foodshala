      ...
      data: {
        ...
        success : function(result){
          ...
          obj.forEach( res => {
            ...
            card += '<td class="project-actions text-right" id="view" value="'+res.menu_id+'"><a class="btn btn-primary btn-sm" href="project-detail.php?id='+res.menu_id+'"><i class="fas fa-folder"></i></a></td>';
            card += '<td class="project-actions text-right" id="edit" value="'+res.menu_id+'"><a class="btn btn-info btn-sm" href="project-edit.php?id='+res.menu_id+'"><i class="fas fa-pencil-alt"></i></a></td>';
