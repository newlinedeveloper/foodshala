    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <?php if(isset($_SESSION['user']) && $_SESSION['user'] === "restaurant") echo '<li><a href="#">'.$_SESSION['res_name'].'</a></li><li class="book-a-table text-center"><a href="dashboard.php">Dashboard</a></li> <li class="book-a-table text-center" id="logout"><a href="index.php">Logout</a></li>'?>
